...
public class IDCardQueryActivity$$ViewInjector<T extends com.canyinghao.canquery.activity.idcard.IDCardQueryActivity> implements Injector<T> {
  @Override public void inject(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131296444, "field 'tv_number'");
    target.tv_number = finder.castView(view, 2131296444, "field 'tv_number'");
    view = finder.findRequiredView(source, 2131296445, "field 'tv_gender'");
    target.tv_gender = finder.castView(view, 2131296445, "field 'tv_gender'");
    view = finder.findRequiredView(source, 2131296446, "field 'tv_birthday'");
    target.tv_birthday = finder.castView(view, 2131296446, "field 'tv_birthday'");
