...
public class AboutMeActivity$$ViewInjector<T extends com.canyinghao.canquery.activity.AboutMeActivity> implements Injector<T> {
  @Override public void inject(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131296337, "field 'tv_version' and method 'click'");
    target.tv_version = finder.castView(view, 2131296337, "field 'tv_version'");
    ...
    view = finder.findRequiredView(source, 2131296336, "field 'tv_have'");
    target.tv_have = finder.castView(view, 2131296336, "field 'tv_have'");
  }
