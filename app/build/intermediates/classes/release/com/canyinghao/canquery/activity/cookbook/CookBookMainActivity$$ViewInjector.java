...
public class CookBookMainActivity$$ViewInjector<T extends com.canyinghao.canquery.activity.cookbook.CookBookMainActivity> implements Injector<T> {
  @Override public void inject(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131296389, "field 'll_hsv'");
    target.ll_hsv = finder.castView(view, 2131296389, "field 'll_hsv'");
    view = finder.findRequiredView(source, 2131296390, "field 'gridview'");
    target.gridview = finder.castView(view, 2131296390, "field 'gridview'");
  }
