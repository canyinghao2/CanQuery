...
public class MainActivity$$ViewInjector<T extends com.canyinghao.canquery.activity.MainActivity> implements Injector<T> {
  @Override public void inject(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131296365, "field 'tv_histroy'");
    target.tv_histroy = finder.castView(view, 2131296365, "field 'tv_histroy'");
    view = finder.findRequiredView(source, 2131296364, "field 'tv_time'");
    target.tv_time = finder.castView(view, 2131296364, "field 'tv_time'");
    view = finder.findRequiredView(source, 2131296363, "field 'tv_title'");
    target.tv_title = finder.castView(view, 2131296363, "field 'tv_title'");
    view = finder.findRequiredView(source, 2131296353, "field 'tl', method 'click', and method 'onTouch'");
    target.tl = view;
    ...
    view = finder.findRequiredView(source, 2131296395, "field 'll_cookitem' and method 'onTouch'");
    ...
    view = finder.findRequiredView(source, 2131296366, "field 'll_travel' and method 'onTouch'");
    ...
    view = finder.findRequiredView(source, 2131296541, "field 'll_weather', method 'click', and method 'onTouch'");
    target.ll_weather = finder.castView(view, 2131296541, "field 'll_weather'");
    view.setOnClickListener(
      new butterknife.internal.DebouncingOnClickListener() {
        @Override public void doClick(
          android.view.View p0
    ...
    view = finder.findRequiredView(source, 2131296328, "field 'tv_city'");
    target.tv_city = finder.castView(view, 2131296328, "field 'tv_city'");
