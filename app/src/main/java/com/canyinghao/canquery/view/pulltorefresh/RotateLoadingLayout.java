...
public class RotateLoadingLayout extends LoadingLayout {
    ...
    protected View createLoadingView(Context context, AttributeSet attrs) {
        View container = LayoutInflater.from(context).inflate(R.layout.community_pull_to_refresh_header2, null);
        return container;
    }
    ...
    public void onPull(float scale) {
        ...
        ImageViewRotationHelper helper = new ImageViewRotationHelper(mArrowImageView);
        helper.setRotation(angle);
